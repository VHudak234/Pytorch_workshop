...
src_path=${repo_home}/imdb_data/input

# input data directory path on the scratch disk of the node
dest_path=${SCRATCH_HOME}/imdb_data/input
mkdir -p ${dest_path}  # make it if required
echo "File source: $src_path"
echo "File destination: $dest_path"
...
src_path=${SCRATCH_HOME}/imdb_data/output
mkdir -p src_path
dest_path=${repo_home}/imdb_data/output
rsync --archive --update --compress --progress ${src_path}/ ${dest_path}
